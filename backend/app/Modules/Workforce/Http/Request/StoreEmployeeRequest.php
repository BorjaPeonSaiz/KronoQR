...
/**
 * `POST /api/v1/employees` (contrato `CreateEmployeeRequest`).
 *
 * Sin `site_id`: el alta queda en el centro de la instalacion (ADR-040), y
 * `RejectsUnknownInput` rechaza el campo si alguien lo envia. Sin
 * `employee_code`: lo genera el servidor (RF-ID-06).
 */
