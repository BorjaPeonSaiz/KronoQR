 ...
 * (doc 01 §5.2).
 *
 * **La invariante la declara el indice parcial
 * `one_active_credential_per_employee`**, y esta excepcion es su eco en PHP: el
 * repositorio lo intenta y traduce el choque, en lugar de comprobar antes con un
 * `SELECT` que seria una condicion de carrera con aspecto de comprobacion —dos
 * peticiones simultaneas la pasarian las dos—.
 *
