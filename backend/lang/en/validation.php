...
return [
    ...
    */
    ...
    // KronoQR: `RejectsUnknownInput`. The field name is shown as sent, on
    // purpose: it is unknown, so there is no label to translate it to.
    'unknown_field' => 'The field :attribute is not part of this request.',
    ...
    */
    ...
    'attributes' => [
        ...
        'group_by' => 'grouping',
        'hired_at' => 'hire date',
        'include_open_shifts' => 'count days with an open shift',
        'intent' => 'intent',
        ...
        'page' => 'page',
        'password' => 'password',
        'pending' => 'pending-only filter',
        'pending_queue_size' => 'pending queue size',
        'per_page' => 'page size',
        'pin' => 'PIN',
        'pin_sealed' => 'sealed PIN',
        ...
        'scans' => 'scans',
        'scans.*.intent' => 'intent',
        'scans.*.occurred_at' => 'time of the scan',
        'scans.*.qr_payload' => 'QR code',
        'scans.*.scan_id' => 'scan identifier',
