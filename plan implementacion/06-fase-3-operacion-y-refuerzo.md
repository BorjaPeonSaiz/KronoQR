...
19. **El modelo de amenazas tiene once filas (H-12):** se corrige el «doce» de esta ficha. Las candidatas a fila nueva (manipulación del reloj del quiosco, repudio de la lectura de datos por un responsable) se anotan en `HANDOFF.md` como decisión del usuario, no se inventan.
