...
export default defineConfig({
  ...
  // (criterio doc 02 §9.2 «cero pruebas intermitentes»; tarea 3.7, decision
  // 9). Si aparece, se gana la carrera declarando la condicion, nunca con un
  // reintento que la esconda.
  retries: 0,
  workers: 1,
