...
Portal del empleado de KronoQR. Vue 3.5 + TypeScript estricto + Vite 6 + Tailwind 4 (doc 02 §3.3).
...
El servicio `node-portal` de Compose sigue sirviendo para levantar Vite dentro de la red de
