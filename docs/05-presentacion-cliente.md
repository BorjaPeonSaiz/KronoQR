...
**Qué se pierde exactamente al caducar**, para que no haya que preguntarlo: los **informes por periodo** —el cuadro de horas trabajadas frente a contratadas—, la **actualización en tiempo real** de la pantalla de presencia, que pasa a refrescarse por sondeo cada pocos segundos en lugar de al instante, y la **marca blanca**: el logotipo y el color del hotel dejan de aplicarse y la tablet, el panel, el portal y los documentos PDF vuelven al aspecto por defecto del producto. **El nombre del hotel se conserva siempre**, también en ese caso, porque es lo que encabeza la exportación para la Inspección y los informes sellados y un documento con valor probatorio tiene que seguir diciendo de quién es el registro. El logotipo y el color configurados no se borran: vuelven a aplicarse solos al renovar, sin volver a configurar nada. Se pierden también, cuando existan, las funcionalidades accesorias que el plan incluya —informes avanzados con comparación entre periodos, cuadro de impacto y adopción, exportación configurable para nómina y resumen semanal por correo— y la telemetría opcional, que ya viene desactivada de serie. Nada más. El fichaje, la sincronización de las tablets, la consulta de jornadas, el portal del empleado, la exportación para la Inspección, las correcciones, el registro de auditoría y las copias de seguridad **no se tocan**.
