...
|---|---|---|---|
| `RNF-M-01` | 0 | `html/tests/Architecture/QualityGatesTest.php:68` — exige los umbrales de cobertura del dominio y del backend | Cobertura de pruebas: ≥ 90 % en la capa de dominio, ≥ 75 % global |
...
| `RN-05` | 1 | `html/tests/Support/FakeTestSource.php:14` — (fichero)<br>`html/tests/Support/FakeTestSource.php:34` — nombre<br>`html/tests/Unit/Quality/TagScannerTest.php:20` — (fichero) | La jornada laboral (work_date) es la fecha civil, en la zona del centro, del clocked_in_at del tramo que abre la jornada |
| `RN-06` | 1 | `html/tests/Support/FakeTestSource.php:60` —  | El total diario se recalcula como suma de los tramos de esa jornada dentro de la misma transacción; nunca se incrementa de forma acumulativa |
...
| `RQ-01` | 1 | — | Toda regla de negocio del §4 tiene al menos una prueba unitaria en el dominio, sin base de datos ni framework |
