...
| `read_only` | In addition, **read** working days, workforce and audit trail | Change anything, **or read the absence register**: it carries health data (the "Sick leave" type and its note) and no support access reaches it, with this scope or any other (403; closed at the Phase 3 close) |
