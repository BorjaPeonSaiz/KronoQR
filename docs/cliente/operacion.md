...
| `read_only` | Además, **leer** jornadas, plantilla y auditoría | Cambiar nada, **ni leer el registro de ausencias**: lleva dato de salud (el tipo «Baja médica» y su nota) y ningún acceso de soporte lo alcanza, con este alcance ni con ninguno (403; cerrado en el cierre de la Fase 3) |
