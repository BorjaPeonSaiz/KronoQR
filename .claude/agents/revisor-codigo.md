...
- `docs/02-stack-tecnologico-y-plan-implementacion.md` §10.3 (Definición de Terminado)
...
**5. Definición de Terminado.** Recorre la lista del documento 02 §10.3 y señala lo que falte: contrato OpenAPI, prueba de autorización negativa, métrica, entrada de auditoría, migración reversible, textos en ES y EN, ADR si la decisión es estructural.

**6. Deuda que se introduce.** Un `TODO` sin ticket, una excepción tragada, un `@phpstan-ignore` sin justificar, una consulta sin índice que hoy va rápida con 100 filas y en un año tendrá 2 millones.
